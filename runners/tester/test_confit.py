...
def load_model(test_args: EmbeddingNetworkTestArguments, model_args: ModelArguments):
    ...
    loaded_model_args = ConFitModelArguments(**model_args_dict)

    model = ConFitModel(loaded_model_args)
...
def main(test_args: EmbeddingNetworkTestArguments, model_args: ModelArguments, logging_args: LoggingArguments):
    ...
    ) = get_metric_and_representations(model, loaded_model_args, test_args, all_test_data)
    ...
    ## evaluate speed
    eval_speed = evaluate_speed(model, loaded_model_args, test_args, all_test_data)
...
if __name__ == "__main__":
    parser = HfArgumentParser(
        dataclass_types=(EmbeddingNetworkTestArguments, ModelArguments, LoggingArguments),
