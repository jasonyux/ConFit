...
def load_data(
    ...
    if args.dset == 'IntelliPro':
        ...
        all_resume_data = pd.read_csv('dataset/IntelliPro/all_resume_eda_n_chatgpt.csv')
        all_resume_data['user_id'] = all_resume_data['user_id'].astype(str)
        all_resume_data.index = all_resume_data['user_id'].values

        all_job_data = pd.read_csv('dataset/IntelliPro/all_jd_eda_n_chatgpt.csv')
        ...
        training_labels = pd.read_json('dataset/IntelliPro/train_labeled_data_eda_n_chatgpt.jsonl', lines=True)
