...
if __name__ == '__main__':
    ...
    # model_checkpoints/openai/IntelliPro/all_resume_train_embeddings.jsonl
    # model_checkpoints/bert-base-multilingual-cased/IntelliPro/all_resume_train_embeddings.jsonl
    ...
    parser.add_argument(
        ...
        default="model_checkpoints/openai/IntelliPro/all_resume_train_embeddings.jsonl"
    )
    parser.add_argument(
        '--resume_test_embedding_path', type=str,
        default="model_checkpoints/openai/IntelliPro/all_resume_test_embeddings.jsonl"
    )
    parser.add_argument(
        '--job_train_valid_embedding_path', type=str,
        default="model_checkpoints/openai/IntelliPro/all_job_train_embeddings.jsonl"
    )
    parser.add_argument(
        '--job_test_embedding_path', type=str,
        default="model_checkpoints/openai/IntelliPro/all_job_test_embeddings.jsonl"
    )
